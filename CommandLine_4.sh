...
if len(SCC_avg_path_lengths) > 0:
    avg_shortest_path_length = sum(SCC_avg_path_lengths) / len(SCC_avg_path_lengths)
    min_shortest_path_length = min(SCC_avg_path_lengths)
    max_shortest_path_length = max(SCC_avg_path_lengths)
    first_quartile = pd.Series(SCC_avg_path_lengths).quantile(0.25)
    third_quartile = pd.Series(SCC_avg_path_lengths).quantile(0.75)
else:
...
print(f"Average shortest path length among SCCs with paths: {avg_shortest_path_length}")
print(f"Minimum shortest path length: {min_shortest_path_length}")
print(f"Maximum shortest path length: {max_shortest_path_length}")
